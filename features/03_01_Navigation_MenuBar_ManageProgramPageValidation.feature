Feature: Navigation
  ...
  Scenario: Verify any broken links on program page
    When Admin clicks on different buttons on the navigation bar
  ...
  Scenario: Verify heading in manage program
    Then Admin should see the heading on paogram page as "Manage Program"

  @VerifyProgramModuleDetails
  Scenario: Verify view details of programs
    Then Admin should able to see "Program Name, Program Description, Program Status" for each program
